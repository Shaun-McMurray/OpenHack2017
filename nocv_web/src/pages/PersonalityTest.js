        ...
        <div className="container">
            <Jumbotron>
                <Panel collapsible defaultExpanded header="Personality test">
                    <ListGroup fill>
                        <ListGroupItem>You often get so lost in thoughts that you ignore or forget your
                            surroundings.</ListGroupItem>
                        <ListGroupItem>
                        ...
                        <ListGroupItem>You try to respond to your e-mails as soon as possible and cannot stand a messy
                            inbox. </ListGroupItem>
                        <ListGroupItem>
                        ...
                        <ListGroupItem>You often feel as if you have to justify yourself to other
                            people.</ListGroupItem>
                        <ListGroupItem>
                            <FormGroup>
                                <Label>
                                    Agree
